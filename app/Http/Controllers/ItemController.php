...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('item.index')->with('status',"New item created sucessfully!");
    }
    ...
    public function update($id,Request $request){
        ...
        $item->stock = $request->stock;
        $item->update();
        return redirect()->route('item.index')->with('status'," Item updated sucessfully!");
    }
    public function destroy($id)
    {
        $item = Item::findOrFail($id);
        $item->delete();
        return redirect()->back()->with('status'," item deleted sucessfully!");
    }
}
